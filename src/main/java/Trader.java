...
public class Trader<T> {
     ...
     */
    public void addToWishlist(T wishListObject){
     ...
     */
    public int getSellingPrice(T tradableObject){
        if (tradableObject instanceof Tradable){
            return ((Tradable) tradableObject).getPrice();
        } else{
            return Tradable.MISSING_PRICE;
        }
